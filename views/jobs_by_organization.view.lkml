...
# TODO: this was failing because sum_errors annd the p90_sum_errors weren't defined.
  measure: sum_errors_vs_threshold {
    #type: sum_distinct
    #sql_distinct_key: ${job_id} ;;
    type: number
    sql: SAFE_DIVIDE(${sum_other_errors}, ${thresholds.threshold_sum_other_errors}) *100 ;;
  }
